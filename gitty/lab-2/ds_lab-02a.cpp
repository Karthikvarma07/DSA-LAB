...
scanf("%d",&*choice); //creating the menu
...
} //choice to pick palinrome or armstorng or perfect number
else{
...
if(*choice>4){
printf("re enter the number"); //reentering if the mumber ids out side the menu
}
